        ...
        <div class="header-top">
            <div class="wrapper">
                <div class="header-logo">
                    <a href="contact.php" class="logo">Book Now</a>
                </div>
                <div class="center-log">
                    <a href="index-2.html"><img src="assets/upload/logo.png" alt="..."></a>
                </div>
                    ...
                    <div class="ak-main_header_right">
                        <div class="ak-nav ak-medium">
                            <ul class="ak-nav_list">
                                ...
                                <!-- <li>
                                    <a href="index.php">Rajwada</a>
                                </li>
                                <li>
                                    <a href="about.php">Subharambh</a>
                                </li>
                                <li>
                                    <a href="service.php">Vasundhara</a>
                                </li>

                                <li>
                                    <a href="contact.php">Private Villa</a>
                                </li> -->
                                <li class="menu-item-has-children">
                                    <a href="service.php">Service</a>
                                    <ul>
                                        <li>
                                            <a href="rajwada.php">Rajwada Palace</a>
                                        </li>
                                        <li>
                                            <a href="subharambh.php">Subharambh Courtyard</a>
                                        </li>
                                        <li>
                                            <a href="vasundhara.php">Vasundhara Lawn</a>
                                        </li>
                                        <li>
