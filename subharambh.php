    ...
    <div id="scrollsmoother-container">
            ...
            <div class="ak-commmon-hero ak-style1 ak-bg" data-src="assets/img/banner_top_all.png">
                <div class="ak-commmon-heading">
                    <div class="ak-section-heading ak-style-1 ak-type-1 ak-color-1 page-top-title">
                        ...
                        <h2 class="ak-section-title page-title-anim">Subharambh Courtyard</h2>
                    </div>
                </div>
            </div>
        </Section>
        ...
        <section class="container">
            ...
            <div class="blog-details">
                <h3 class="anim-title-3">Where Every New Beginning Feels Special</h3>
            ...
            <div class="row" id="containerAround">
                <div class="col-md-8">
                    <div class="blog-content" id="scrollGaleria">
                        ...
                        <p>Subharambh Courtyard is designed for intimate, elegant, and heartfelt celebrations. Whether it’s a wedding ceremony, engagement, anniversary, or family gathering, this venue blends warmth, beauty, and sophistication in perfect harmony.
                        </p>
                        <p>It’s where love stories begin and milestones are celebrated beautifully.</p>

                        <!-- Start Extra -->
                        <div class="ak-height-50 ak-height-lg-30"></div>

                        <h5 class="anim-title-2 ak-white-color">Elegant Yet Intimate Design</h5>

                        <div class="ak-height-15 ak-height-lg-15"></div>

                        <p>
                            Subharambh Courtyard offers a cozy ambiance without compromising on luxury.
                        </p>

                        <div class="ak-height-10 ak-height-lg-10"></div>

                        <ul class="ak-list-style">
                            <li>Tasteful décor with a welcoming atmosphere</li>
                            <li>Perfect balance of indoor & outdoor spaces</li>
                            <li>Ideal for close-knit celebrations</li>
                        </ul>
                        ...
                        <h5 class="ak-white-color">Venue Spaces</h5>
                        ...
                        <div class="blog-details">
                            <div class="blog-details-subtitle">
                                ...
                                <div>
                                    <h5 class="anim-title-3 ak-white-color">🏛️ Elegant Hall</h5>
                                    <ul>
                                        <li>4,000 sq. ft indoor hall</li>
                                        <li>Ideal for ceremonies, receptions, and rituals</li>
                                ...
                                <div>
                                    <h5 class="anim-title-3 ak-white-color">🌿 Open Lawn</h5>
                                    <ul>
                                        <li>6,000 sq. ft landscaped lawn</li>
                                        <li>Beautiful setting for daytime and evening functions</li>
                                        <li>Poolside view adds charm to celebrations</li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    <h5 class="anim-title-3 ak-white-color">💧 Pool Area</h5>
                                    <ul>
                                        <li>10,000 sq. ft pool area</li>
                                        <li>Perfect for pre-wedding functions, mehendi & cocktail nights</li>
                                    </ul>
                                </div>
                        ...
                        <div class="ak-height-75 ak-height-lg-30"></div>
                       <h4 class="anim-title-2 ak-white-color">Why Subharambh Courtyard?</h4>
                       <div class="ak-height-20 ak-height-lg-20"></div>

                        <ul class="ak-list-style">
                            <li>Ideal for medium-scale celebrations</li>
                            <li>Elegant and peaceful ambiance</li>
                            <li>Flexible décor themes</li>
                            <li>Perfect blend of indoor & outdoor spaces</li>
